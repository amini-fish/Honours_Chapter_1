...
expanded_data$Kinship.Method <- recode_factor(expanded_data$Kinship.Method, "Cervus" = "CERVUS", "CERVUS " = "CERVUS", "VCFtools (Yang)" = "VFCtools", "CKMRsim " = "CKMRsim", "Sequioa " = "Sequoia", "GENAlEX" = "GenAlEx", "KING" = "KING-Robust", "Allele counts  " = "Allele counts", "VFCtools" = "VCFtools", "KinGroup  " = "KinGroup", "KINANALYZER" = "KINALYZER")
...
Cat_Con_frame <- data.frame(Kinship.Method = c("Allele counts", "CERVUS", "CKMRsim", "COANCESTRY", "COLONY", "demerelate", "Endelman Jannik", "FAMOZ", "GenAlEx", "GERUD", "KINALYZER", "Kinference", "KING-Robust", "KinGroup", "Kinship", "ML-Relate", "Sequoia", "SPAGeDi", "VCFtools"), 
...
estimator$Kinship.Method <- recode_factor(estimator$Kinship.Method, "CERVUS " = "CERVUS", "Allele counts  " = "Allele counts", "CKMRsim " = "CKMRsim", "KinGroup  " = "KinGroup", "Sequioa " = "Sequoia", "Cervus" = "CERVUS", "Coancestry" = "COANCESTRY", "demerelate" = "Demerelate")
...
Cat_Con <- c("Cat", "Cat", "Cat", "Con", "Cat/Con", 
             "Cat", "Cat", "Con","Cat", "Con", "Con", 
             "Con", "Con", "Cat", "Cat", "Con", "Cat", "Cat", "Con")
...
estimator$Kinship.Method <- recode_factor(estimator$Kinship.Method, "KINANALYZER" = "KINALYZER")
...
expanded_data$Kinship.Method <- recode_factor(expanded_data$Kinship.Method, "VFCtools" = "VCFtools", "KINANALYZER" = "KINALYZER",  "Coancestry" = "COANCESTRY", "demerelate" = "Demerelate")
...
## Not needed here just storing for safe keeping
```{r Supplementary Table 1, echo = F, warning = F}
Tab_S1 <- readr::read_csv("C:/Users/samue/Desktop/Honours/Chapter_1_lit_review/Metadata/Table_S1_data.csv")
Tab_S1
knitr::kable(
  Tab_S1,
  format = "latex",
  caption = "Table S1. The number of studies published on each elasmobranch species within each relatedness research category. Species are presented with major groups rays (Batoidea) and sharks (Selachii). Note that studies can be assigned to multiple categories."
) %>%
